...
logging.info("Hyperparameter tuning initiated in Random Forest.......")
def hyperparameter_tuning_rf(model, x, y, final_features):
    params = { 
...
model_rf = hyperparameter_tuning_rf(pipe6, x_train, y_train, features)
logging.info("Random forest trained.")

# Using randomized search cv to get the best parameter values
logging.info("Hyperparameter tuning initiated in XGBoost.......")
def hyperparameter_tuning_xgb(model, x, y, final_features):
    params = { 
...
model_xgb = hyperparameter_tuning_xgb(pipe4, x_train, y_train, features)
logging.info("XGBoost trained.")

# Finally saving our model as a pickle file (For deployment)
